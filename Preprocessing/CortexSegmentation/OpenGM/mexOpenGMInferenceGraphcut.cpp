...
//typedef opengm::external::MinSTCutKolmogorov<size t, double> MinCut;
...
#define UNARYPOTENTIALS prhs[0]
    ...
    opengm::PottsFunction<double> f(2, 4, 0, 1.0); // penalty of 1 in case of unequal values
